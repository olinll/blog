...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ri:qq-line', text: '交流群: 1105154206', url: 'https://qm.qq.com/q/xa6asvKOZM' },
			{ icon: 'tabler:brand-github', text: 'GitHub: olinll', url: 'https://github.com/olinll' },
		...
		nav: [
			...
			// },
			{
				title: '社交',
				items: [
					{ icon: 'tabler:brand-github', text: 'olinll', url: 'https://github.com/olinll' },
					{ icon: 'ri:qq-line', text: '群: 1105154206', url: 'https://jq.qq.com/?_wv=1027&k=lQfNSeEd' },
			...
			},
			{
				...
				items: [
					...
					{ icon: 'tabler:shield-check', text: '苏公网安备32021302003009号', url: 'https://www.beian.gov.cn/' },
				],
			},
		] satisfies Nav,
	},
