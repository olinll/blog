...
updated: 2025-11-11 00:00:00
image: https://img.olinl.com/blog_img/202x/wordpress-build-website_cover-a7bccd.webp
categories:
  - 技术
tags:
  - WordPress
...
推荐：测试环境用 Docker 部署快速验证，生产环境用直接部署以便灵活调优。
...
数据库密码为硬编码示例，生产环境应使用环境变量文件（`.env`）或 Docker Secrets 管理敏感信息。
