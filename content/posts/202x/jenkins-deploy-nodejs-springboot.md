...
updated: 2026-03-30 00:00:00
image: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot_cover-eb455a.webp
categories:
  - 技术
tags:
  - Jenkins
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-6abd92.webp
---
#caption
Jenkins 初始化向导页面
::
...
::link-card
---
title: Linux 手动安装 JDK 1.8
link: /posts/202x/jdk-install/
---
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-f26b55.webp
---
#caption
配置 JDK
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-5af077.webp
---
#caption
配置 Maven
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-2b9967.webp
---
#caption
配置 Node.js
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-d5f021.webp
---
#caption
选择 Node.js 环境
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-35346d.webp
---
#caption
添加构建步骤
::
...
<!-- TODO: 补充截图 ./img/jenkins-deploy-build-success-console.webp (Node.js 构建成功控制台日志) -->
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-8b108c.webp
---
#caption
指定 JDK 版本
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/jenkins-deploy-nodejs-springboot-23ddfc.webp
---
#caption
Maven 构建配置
::
...
<!-- TODO: 补充截图 ./img/jenkins-deploy-springboot-build-success.webp (Spring Boot 构建成功控制台日志) -->
