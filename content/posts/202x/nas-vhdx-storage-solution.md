...
image: https://img.olinl.com/blog_img/202x/nas-vhdx-storage-solution_cover-8af7ef.webp
categories:
  - 技术
tags:
  - NAS
...
::pic
---
src: https://img.olinl.com/blog_img/202x/nas-vhdx-storage-solution-29d7a9.webp
---
#caption
NAS 传输速度对比：大量碎文件 vs 单个大文件 VHDX
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/nas-vhdx-storage-solution-b33f20.webp
---
#caption
FastCopy 扫描预估阶段
::
...
::pic
---
src: https://img.olinl.com/blog_img/202x/nas-vhdx-storage-solution-f77582.webp
---
#caption
FastCopy 实际传输速率
::
...
- **自动挂载：** 你可以将其设置为随系统启动自动挂载，让 NAS 上的碎文件库像本地硬盘一样常驻。
